...
export async function PageWrapper({
	...
	return (
		<>
			<header
				className="px-4 border-b border-solid border-border flex h-16 shrink-0 justify-between items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12"
			>
